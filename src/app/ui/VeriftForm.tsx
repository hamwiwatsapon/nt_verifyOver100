    ...
    <form onSubmit={handleSubmit}>
      <div className="w-full flex flex-col gap-4">
        <div key="flat" className="flex w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4 text-3xl">
            <Input type="text" variant="flat" label="เลขบัตรประชาชน" fullWidth isRequired radius="md" size="lg" maxLength={13} id="cardnumber" onChange={updateID} required/>
            <Input type="text" variant="flat" label="หมายเลขโทรศัพท์" fullWidth isRequired radius="md" size="lg" maxLength={10} id="msisdnd" onChange={updateMsisdn} required/>
          </div>
