...
const Home = () => {
  ...
  return (
    <NextUIProvider>
      <main className="flex min-h-screen min-w-screen w-full flex-col items-center justify-between p-24 bg-gradient-to-tr from-yellow-100 via-yellow-400 to-yellow-500">
