...
export async function POST(req:Request) {
  ...
  try {
    const url = `https://customerapi.xxxxx.com/app/customerapi/v200/search/customer?subscriber_number=${msisdn_cut}&is_active=true`
    ...
    const url_2 = `https://customerapi.xxxxx.com/app/customerapi/v200/search/customer/fetch?id_card_number=${idCardNumber}&is_active=true`
